...
- [ ] 5. CreditsEngine 核心实现
  ...
  - [x] 5.4 编写 charge 的属性测试
    - **属性 5: 扣费操作完整性**
    - **验证需求: 4.1, 4.4**
  
  - [x] 5.5 编写 charge 的属性测试
    - **属性 6: 幂等性保证**
    - **验证需求: 4.2**
  ...
  - [x] 5.9 编写 grant 的属性测试
    - **属性 9: 发放积分增加余额**
    - **验证需求: 6.1, 6.2, 6.3**
  
  - [x] 5.10 编写 grant 的属性测试
    - **属性 10: 发放金额验证**
    - **验证需求: 6.5**
  ...
  - [x] 5.12 编写 queryBalance 的属性测试
    - **属性 11: 余额查询准确性**
    - **验证需求: 7.1**
  
  - [x] 5.13 编写 queryBalance 的属性测试
    - **属性 3: 不存在用户的错误处理**
    - **验证需求: 3.2, 7.2**
  ...
  - [x] 5.15 编写 getHistory 的属性测试
    - **属性 12: 交易历史查询**
    - **验证需求: 8.1, 8.5**
  
  - [x] 5.16 编写 getHistory 的属性测试
    - **属性 13: 分页正确性**
    - **验证需求: 8.2**
  
  - [x] 5.17 编写 getHistory 的属性测试
    - **属性 14: 日期范围过滤**
    - **验证需求: 8.3**
  
  - [x] 5.18 编写 getHistory 的属性测试
    - **属性 15: 操作类型过滤**
    - **验证需求: 8.4**
